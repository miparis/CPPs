...
/*   Updated: 2026/02/01 18:35:38 by miparis          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << PURPLE << "(Assignment const.) " << "ClapTrap " << this->_name << " ready!" << NC << std::endl;
	status();
}
...
void ClapTrap::takeDamage(unsigned int amount)
{
	if (this->_hitPoints <= 0)
		std::cout << RED << "ClapTrap" << this->_name << "Already down!" << NC << std::endl;
	else if (amount >= this->_hitPoints)
	{
		std::cout << YELLOW << "ClapTrap " << this->_name << " receives fatal attack!" << NC << std::endl;
		this->_hitPoints = 0;
	}
	...
	std::cout << RED << "ClapTrap" << this->_name << ". Current HP: " << this->_hitPoints << NC << std::endl;
}
